...
- **Acceso al paquete privado.** `@projectellysia/acheron-core-web` está en GitHub Packages, así que
  hace falta un token con `read:packages` en la variable `NPM_TOKEN`:
